 ...
 * @author bruna
 */
public class ObrigadoPorResponder extends javax.swing.JFrame {

    /**
     * Creates new form ObrigadoPorResponder
     */
    public ObrigadoPorResponder() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObrigadoPorResponder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ObrigadoPorResponder().setVisible(true);
            }
        });
    }
